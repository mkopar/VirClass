...
If you run `build.py` it will generate a few files into 'media/' directory and on into 'models/'.
...
After that, you should call `predict.py`:
...
`raw predicted values:  [ 28.16671371  28.16671371  28.16671753  28.16673088  28.16672516
