...
num_filters_1=32 / 4 # how many different filters to learn at each layer
num_filters_2=48 / 4
num_filters_3=64 / 4
...
noise_l1, noise_l2, noise_l3, noise_l4, noise_py_x = model(X, w, w2, w3, w4, 0.2, 0.5) # noise for prediction
